...
\textbf{Unreal Engine} \cite{Unreal_Engine} je pogonski sklop igre (engl. \emph{game engine})

\textbf{MagicQ Software} \cite{MagicQ_Software} je

\textbf{DMX Template} \cite{dmx_template} je

\textbf{SteamVR} \cite{SteamVR} je

\textbf{HTC Vive} \cite{HTC_Vive} je
